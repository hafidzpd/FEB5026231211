<html>
    ...
    <body>
        <h8 style="color:orange">25 Februari 2025, 16:02</h8>
        <h2 style="border: 2px solid red;background-color:blue;color:white"> Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam</h2>
        <h5 style="color:rgb(75,10,100);">Oleh : itsash <i>|</i> 18 <i>|</i> Source : ITS Online</h5>
        <h1 style="color: #ff752f;00;">testing</h1>
        <h1 style="color: hsl(50,75%,20%);">testing</h1>
        <P>
        ...
        <img
            src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_101353-768x432.jpg"
            alt="Dosen agama islam ITS Prof Dr Ir Adi Soeprijanto MT saat memberikan materi sirah nabawi pada Kuliah Umum Mentoring Agama Islam Semester Genap 2024/2025"
            width="430" height="280" class="roundedimage">
        ...
        <img 
            src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_111422-768x432.jpg"
            alt="Maba ITS dalam kegiatan Mentoring Agama Islam Semester Genap 2024/2025 di Masjid Manarul Ilmi ITS"
            width="430" height="280" class="roundedimage">
        ...
        <div class="btn-group">
            <button class="button">Halo</button>
            <button class="button">Aku</button>
            <button class="button">Hafidz</button>
            <button class="button">Yey</button>
            <button class="button">penugasan</button>
          </div>
